...
public:
    ...
    virtual int getDestinationPort(int& dport,int& sport, const char* destAddress, const char* sourceAddress);
    virtual const char* getDestinationAddressForConnectionFromMNtoHA(int& dport,int& sport, const char* destAddress, const char* sourceAddress);
